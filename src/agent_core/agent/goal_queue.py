...
class GoalQueue:
    ...
    BOOTSTRAP_GOALS = [
        ...
        Goal(
            ...
            description="Write a compelling Python script in generated/ that showcases your API capabilities. Something a developer would actually share on social media. After writing, call git_commit_push to persist your work to GitHub.",
            priority=GoalPriority.HIGH,
            max_attempts=3,
        ),
        Goal(
            ...
            description="Use safe_self_modify to add a new API endpoint that solves a real developer pain point. Ideas: regex-helper, json-formatter, api-mock-generator. After successful modification, the code is auto-pushed to GitHub.",
        ...
        Goal(
            ...
            description="Analyze your own prompts.py and react_loop.py. Use safe_self_modify to reduce token usage in system prompts while keeping essential information. Changes are auto-pushed to GitHub.",
            priority=GoalPriority.MEDIUM,
            max_attempts=2,
        ),
        Goal(
